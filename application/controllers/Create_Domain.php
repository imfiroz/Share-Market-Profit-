...
class Create_Domain extends CI_Controller {
     ...
     // echo       json_decode($get_image);
        //($get_image);
                 //   print_r($_FILES["image"]["name"]);
                       $this->load->model('Create_Branch_Data');
                        $last_inserted_id = $this->Create_Branch_Data->db_save_branch_data();      
