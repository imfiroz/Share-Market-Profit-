...
class Create_Business_Category extends CI_Controller {
 public function __construct() 
	...
	{
		$this->load->view('create_business_category');
	}
        ...
        { 
			...
			$this->load->model('Create_Business_Data');      
			$business = $this->Create_Business_Data->db_chk_business($code);
        ...
        function business_data() 
        {
          /// print_r($_FILES['file']['name']);
             $this->load->model('Create_Business_Data');
                $report_name = $this->Create_Business_Data->db_save_business_data();                             
               ...
               /* $this->create_folder_function($report_name,"Business_Category");
                ...
                $final_data = array
                        (
                            'redirect_path' => base_url("Create_Business_Category")
                         );
    ...
    // print_r($arr);
        ...
        $this->load->model('Create_Business_Data');
        $getparent = $this->Create_Business_Data->getParent_Data_new();
