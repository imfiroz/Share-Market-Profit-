...
class Delete_Services extends CI_Controller {
 public function __construct() 
       ...
       public function index()
	   {
			...
			// $query = $this->db->select('id,Name as text')
						//->limit(10)
						//->get("tbl_level");
						$query=$this->db->query("select tbl_script_level.script_id as id,tbl_script.Name as s_name,tbl_level.Name as l_name from tbl_script_level left join tbl_script on tbl_script_level.script_id=tbl_script.id left join tbl_level on tbl_script_level.level_id=tbl_level.id");
			$json['data1'] = $query->result_array();
			
			
            $this->load->view('Delete_services',$json);
			}
