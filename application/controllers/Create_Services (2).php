...
class Create_Level extends CI_Controller {
 public function __construct() 
    ...
    public function get_state_data() {
     ...
     function level_save_data()
                {
 //  $code = $_POST['get_data'];
     // echo       json_decode($get_image);
        //($get_image);
                 //   print_r($_FILES["image"]["name"]);
                       $this->load->model('Create_Level_Data');
                        $last_inserted_id = $this->Create_Level_Data->db_save_branch_data();      
                       // $this->create_folder_function($last_inserted_id, "Branch");
                        //$this->global_save_folder_image($last_inserted_id, "Branch", "branch_image", $_FILES["image"]["name"],"branch_txt");
                        $final_data = array
                                (
                           'redirect_path' => base_url("Create_Branch")
                            );
