...
<div id="page-content-wrapper">
            <div id="page-content" style="margin:0">
                    ...
                    <div class="container" style="background:#f3e97a47">
<div id="page-title">
      <h2 style="margin-left: 40%">Create Vendor</h2> 
    ...
    <div id="theme-switcher-wrapper">
        <div class="scroll-switcher">
            ...
            <div class="theme-color-wrapper clearfix">
				...
				<div class="panel" style="margin-left: 202px; margin-right: 210px;">
					<div class="panel-body" >
						<h3 class="title-hero">
						   FILL YOUR DETAILS
						</h3>
                                            <h1 class="title-hero" style="text-transform: lowercase;
    font-size: 11px;">
						...
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row"  id="btnCustLogin" name="btnCustLogin" method="post">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<textarea name="txt_description" id="txt_description" rows="3" class="form-control textarea-counter"></textarea>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" name="txt_phone" id="txt_phone" onblur="ValidatePhone()"  maxlength="10" placeholder="Enter Mobile...">
										   <div id="email1"></div>
									</div>
								</div>
								  ...
								  <div class="form-group">
                                                              ...
                                                              <div class="form-group">
                                                                  <div class="col-sm-12">
									<label class="col-sm-3 control-label">Listings</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" name="txt_list" id="txt_list">
			
									</div>
                                                                        <div class="col-sm-3">
                                                                                   <a   href="javascript:void(0);" class="btn btn-alt btn-hover btn-black"  onclick="abc()" style="margin-left: -20px;">Add</a>     
										  <!--<button class="btn btn-alt btn-hover btn-black" id="btnCustLog">+</button>-->
									</div>
                                                                        <div class="col-sm-6" id="data_to_show">
								...
								<div class="form-group">
									...
									<label class="col-sm-3 control-label">Business*</label>
                                        ...
                                        <label class="col-sm-3 control-label">Categories*</label>                                     
                                         ...
                                         <div id="pageContent1" class="dropdown open "> 
    	...
    	function ValidatePhone()
{
 ...
 $("form[name='btnCustLogin']").submit(function (e) {
	...
	//var business_category=$("#business11").val();
         ...
         if(name == "" || txt_email == "" || txt_phone == "" || password == "")
         {
...
if(business!="" && business!=null){
     ...
     var i=0;var array=[]; var check=1;
     function abc(){
 
  var get_value= $("#txt_list").val();
 if(get_value=="" || get_value==null){
  alert("Please Add Listing")
 }
 else{
     if(i==0){
     array.push(get_value);
     var element = document.createElement("input");
     element.setAttribute("type", "text");
     element.setAttribute("value",get_value);
       element.setAttribute("id","ide"+i);
     var foo = document.getElementById("data_to_show");
      foo.appendChild(element);
        ...
        i++;
        $('[name="multiselect[]"]').val(array);
 }
 else{
  
   for(var j=0;j<array.length;j++){
      //alert(array[j]);
       if(array[j]==get_value){
...
for(var k=0;k<m;k++){
var index = array.indexOf(mi);
if (index >= 0) {
  array.splice( index, 1 );
}
}
	$('[name="multiselect[]"]').val(array);
	var ni = document.getElementById('data_to_show');
 ...
 $('#aaa').on('click', function () {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>" + "Welcome/get_city1_new",
            data: 'city=' + get_data,
            dataType: 'json',
            success: function (res) {                
                var points = [];
