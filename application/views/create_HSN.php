						...
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row"  method="post" id="button_submit1" name="button_submit1">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="hsn_code" name="hsn_code" placeholder="Enter HSN Code..." onblur="validate_hsn()">
                                                                                   <div id="code_verification"></div>
									</div>
								</div>
								 <div class="form-group">
									<label class="col-sm-3 control-label">HSN Description</label>
									<div class="col-sm-6">
										<textarea name="hsn_decription" id="hsn_decription" rows="3" class="form-control textarea-counter"></textarea>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" name="igst" id="igst" placeholder="Enter IGST..." onkeypress="return isNumber(event);">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">CGST</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" name="cgst" id="cgst" placeholder="Enter CGST..." onkeypress="return isNumber(event);">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">SGST</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" name="sgst" id="sgst" placeholder="Enter CGST..." onkeypress="return isNumber(event);" >
									</div>
								</div>								
								<div>
