     ...
     function get_branch_details()
                                    {
                                        var u_id = $("#v_id").val();            
                                        $.ajax({
                                            url: "<?php echo base_url(); ?>View_Domain/fetch_branch_details/",
                                            method: "POST",
                                            data: "u_id=" + u_id,
                                            dataType: "json",
                                            success: function (data)
                                            {
                                               // alert(JSON.stringify(data));
                                                  var content = "";               
                                                var len = data.length;
                                                content +="<thead><tr> <th>Sr No.</th><th>Url</th><th>Edit</th><th>Delete</th></tr></thead>";
                                    ...
                                    function edit_branch(id)
                                            {
                                                ...
                                                $.ajax({
                                                    url: "<?php echo site_url('View_Domain/ajax_edit_branch/') ?>" + id,
                                                    type: "POST",
                                                    dataType: "JSON",
                                                    success: function (data)
                                                    {
                                                       ...
                                                       verification1 =(JSON.stringify(data.table[0].email));
                                                        ...
                                                        $('[name="branch_name"]').val(data.table[0].url);
                                              ...
                                              function delete_branch(id)
                                                   {
                                                      ...
                                                      var id = id;
                                                              ...
                                                              $.ajax
                                                              ({
                                                                   url: "<?php echo site_url('View_Domain/ajax_delete_branch/') ?>" + id,
                                                                   type: "GET",
                                                                  // dataType: "JSON",
                                                                   success: function (data)
                                                                    {
...
//alert(str);                                         
                                                $.ajax({
                                                    url: "<?php echo base_url(); ?>View_Domain/save_update_branch/" + cust_id,
                                                    method: "POST",
                                                    data: str,
                                                   // dataType: "json",
