					...
					<div class="example-box-wrapper">
						<form class="form-horizontal bordered-row"  id="button_submit" name="button_submit" method="post">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="Code" name="Code" placeholder="Enter Name..." onblur="validate_state_code()">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea name="code_decription" id="code_decription" rows="3" class="form-control textarea-counter"></textarea>
									<div class="character-remaining clear input-description">125 characters left</div>
								</div>
							</div>   
							 <button class="btn btn-alt btn-hover btn-black" href="#" style="margin-left:450px" id="submit_form">
								<span>Submit</span>
    ...
    function validate_state_code()
	{
            ...
            var codeformat = /^[0-9a-zA-Z\s]+$/;                    
				...
				{                                                                  
				  ...
				  helpemail.innerHTML = "Please Enter code";
			...
			if(code!="" && code.match(codeformat))
                                         {   
                                            $.ajax
                                            ({	
                                              url: "<?php echo base_url(); ?>"+"Create_State_Master/check_state",    
                                              ...
                                              success: function(data)  
                                                 {	
                                                             //alert(data);
                                                    if(data==0){								
                                                                            $("#code_verification").html("<span style='color:red;'>Please enter another  code its already in use</span>");
                                                                            document.getElementById("submit_form").disabled = true;							
                                                                            }
                                                             else	{
                                                                             $("#code_verification").html("<span style='color:green;'> code Valid</span>");
											 ...
											 helpemail.style.color = 'red';
				  helpemail.innerHTML = "Please Enter Valid Code";
				  document.getElementById("submit_form").disabled = true;
										}
								}
			return false;				
         ...
         $("form[name='button_submit']").submit(function(e)
            {
                        ...
                        e.preventDefault();
                        var name=$("#Code").val();
                        var state_dscrp=$("#code_decription").val();                      	 
                        if(name == "" || state_dscrp == "")
                           {
                               alert("Please insert required fields");
                                   ...
                                   $.ajax({
                                        url: "<?php echo base_url(); ?>"+"Create_State_Master/state_data",
                                       type: "POST",
                                       data: formData,
                                       async: false,
                                       dataType:'JSON',
                                       success: function (msg)
                                                     {	
                                                        ...
                                                        {	
                                                          ...
                                                          window.location ="<?php echo base_url();?>"+"View_State_Master";			
                                                         }				
                                                      },
                                       cache: false,
                                       contentType: false,
