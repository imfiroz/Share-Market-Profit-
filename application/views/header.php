...
<head>
	...
	$business_sub_category_id=$this->session->userdata('business_sub_category_id');
...
<!-- Favicons -->
<!--
<link rel="shortcut icon" sizes="144x144" href="<?php echo base_url()?>icons/stylevalley.png">
<link rel="shortcut icon" sizes="114x114" href="<?php echo base_url()?>icons/stylevalley.png">
<link rel="shortcut icon" sizes="72x72" href="<?php echo base_url()?>icons/stylevalley.png">
<link rel="shortcut icon" href="<?php echo base_url()?>icons/stylevalley.png">-->
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/widgets/datatable/datatable-fixedcolumns.js"></script>
     ...
     <script type="text/javascript" src="<?php echo base_url() ?>assets/widgets/datatable/datatable-tabletools.js"></script>
      ...
      <!--  <script type="text/javascript" src=" http://requirejs.org/docs/release/2.2.0/minified/require.js"></script>-->
	   ...
	   <script type="text/javascript" src="<?php echo base_url() ?>js/jquery.AshAlom.gaugeMeter-2.0.0.min.js"></script>
...
<div id="sidebar-toggle-4" class="collapse in">
    ...
    <div id="mobile-navigation">
        ...
        <a href="index.html" class="logo-content-small" title="StyleValley"></a>
    </div>
    <div id="header-logo" class="logo-bg">
        <a href="<?php echo base_url('Dashboard');?>" class="logo-content-big" title="StyleValley">
             Stock&<i>Treding</i>
          
        </a>
        <a href="index2.php" class="logo-content-small" title="StyleValley">
            Stock&<i>Treding</i>
    ...
    <div id="header-nav-left">
        <div class="user-account-btn dropdown">
         ...
         <div id="page-sidebar"  style="border-right: 1px solid red">
	...
	<li id="test">
       ...
       <!-- .sidebar-submenu -->
        <input type="hidden" class="form-control" placeholder="Enter GSTIN"value="<?php echo $role_id;?>" name="id_display" id="id_display">
         <input type="hidden" class="form-control" placeholder="Enter GSTIN"value="<?php echo $is_approved;?>" name="is_approved" id="is_approved">
      
    </li>
  <li> 	<span id="pending_invoices" style="color:red; display:none">Invoices pending</span>	  
  <ul id="myList"> 
		   ...
		   success: function(data)  
		   {
                   ...
                   //  console.log(data);
                       ...
                       var content="";
                        var temp="";
							   ...
							   for(var i=0;i<data.length;i++)
                                ...
                                var a=data[i].role_id;                                  
                                   var array = a.split(',');
                                    var admin1 = parseInt(array[0]);
                                      var admin=(isNaN(admin1))?0:admin1;
                                       var badmin1 = parseInt(array[1]);
                                      var badmin=(isNaN(badmin1))?0:badmin1;
                                    var vendor1 = parseInt(array[2]);                                   
                                  var vendor=(isNaN(vendor1))?0:vendor1;                                   
                                    var role_id=$("#role_id").val();
                                      var check_approval=$("#is_approved").val();
                                    if(admin==5 && role_id ==5){                                 
                                    ...
                                    else
                                    {
                                        ...
                                        content+='<li >';
                                        content+='<a href="#">';
                                        content+='<i class="fa" ><img src="<?php echo base_url();?>icons/'+data[i].fa_fa_icon+'" width="16px" height="18px"><span style="font-size: 18px;color:#606f8d;font-weight:bold;">'+temp+'</span></i>';
					...
					content+='<div class="sidebar-submenu">',
                                   ...
                                   if(badmin==1 && role_id ==1){
                                    if(data[i].parent==temp)
                                    {										
                                        content+='<li ><a href="'+data[i].onclick+'"><img src="<?php echo base_url();?>icons/'+data[i].fa_fa_icon+'" width="16px" height="18px"><span style="color:#606f8d;font-weight:bold;">'+data[i].child+'</span></a></li>';
                                    }
                                    else
                                    {//alert(data[i].fa_fa_icon);
                                        ...
                                        content+='<li >';
                                        content+='<a href="#">';
                                        content+='<i class="fa" ><img src="<?php echo base_url();?>icons/'+data[i].fa_fa_icon+'" width="16px" height="18px"><span style="color:#606f8d;font-weight:bold;">'+temp+'</span></i>';
                                        content+='<span class="pull-right-container">';
                                     //   content+='<i class="fa fa-angle-left pull-right"></i>';
										...
										content+='<div class="sidebar-submenu">',
                                        content+='<ul style="list-style: none;">';
                                        //content+='<li><a href="'+data[i].onclick+'"><span style="color:red;font-weight:bold;">'+data[i].child+'</span></a></li>';
										 content+='<li ><a href="'+data[i].onclick+'"><img src="<?php echo base_url();?>icons/'+data[i].fa_fa_icon+'" width="16px" height="18px"><span style="color:#606f8d;font-weight:bold;">'+data[i].child+'</span></a></li>';
							   ...
							   for(var i=0;i<data.length;i++)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        content+='<li >';
                                        content+='<a href="#">';
                                        content+='<i class="fa" ><img src="<?php echo base_url();?>icons/chaptermaster.png" width="16px" height="18px"><span style="color:#606f8d;font-weight:bold;">'+temp+'</span></i>';
                                        content+='<span class="pull-right-container">';
                                     // content+='<i class="fa fa-angle-left pull-right"></i>';
                                        content+='</span>';        
                                        content+='</a>';   
										content+='<div class="sidebar-submenu">',
                                        content+='<ul style="list-style: none;">';
                                        content+='<li><a href="'+data[i].onclick+'"><img src="<?php echo base_url();?>icons/chaptermaster.png" width="10px" height="12px"><span style="color:#606f8d;font-weight:bold;font-size:17px">'+data[i].child+'</span></a></li>';
...
*/
         ...
         function Logout_user()
	 {
        ...
        function Edit()
	 {
		window.location = "<?php echo base_url()?>Edit_Profile";
	 }
	 $(document).ready(function () {
 ...
 if(value==0){
   $.ajax({ 
		   ...
		   {	
                      ...
                      //  alert(len);
                        if(data1.length==null || data1.length==0 ){
...
//                                                            location.reload();
//                                                            
                                                        document.location.href="<?php echo base_url();?>"+"View_Invoice";
