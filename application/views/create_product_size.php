            ...
            <div class="theme-color-wrapper clearfix">
				...
				<div class="panel">
					<div class="panel-body">
						<h3 class="title-hero">
						   FILL PRODUCT SIZE DETAILS
						</h3>
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row"  method="post" id="button_submit1" name="button_submit1">
								<div class="form-group">
									<label class="col-sm-3 control-label">Size(Code)</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" id="Size" name="Size" placeholder="Enter Size.." onblur="validate_size()">
                                                                                   <div id="size_verification"></div>
									</div>
								</div>
								 <div class="form-group">
									<label class="col-sm-3 control-label">Size Description</label>
									<div class="col-sm-6">
										<textarea name="size_description" id="size_description" rows="3" class="form-control textarea-counter"></textarea>
...
<script>
	...
	{           
            var code=document.getElementById("Size").value;  
            var helpemail=document.getElementById("size_verification");
            var codeformat = /^[0-9a-zA-Z\s]+$/;                    
                if(code=="")
				{                                                                  
                                  helpemail.style.color = 'red';
				  helpemail.innerHTML = "Please Enter Size";
			...
			if(code!="" && code.match(codeformat))
                                         {                                            
                                            $.ajax
                                            ({	
                                              url: "<?php echo base_url(); ?>"+"Create_Product_Size/check_size",                                             
                                              method:"POST",
                                              data: "code_data="+code,
                                              success: function(data)  
                                                 {	                                                           
                                                    if(data==0){								
                                                                    $("#size_verification").html("<span style='color:red;'>Please Enter Another Size It Is Already In Use</span>");
                                                                    document.getElementById("button_submit").disabled = true;							
                                                                 }
                                                             else{
                                                                    $("#size_verification").html("<span style='color:green;'>Size Valid</span>");
                                  ...
                                  helpemail.style.color = 'red';
				  helpemail.innerHTML = "Please Enter Valid Size";
				  document.getElementById("button_submit").disabled = true; 
                                        }
                                        }
			return false;				
                        ...
                        if(size == "" || size_description == "" )
                           {
                               alert("Please insert required fields");
                                   ...
                                   $.ajax({
                                        url: "<?php echo base_url(); ?>"+"Create_Product_Size/size_data",
                                       type: "POST",
                                       data: formData,
                                       async: false,
                                       dataType:'JSON',
