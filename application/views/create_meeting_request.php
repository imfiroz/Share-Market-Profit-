									...
									<label class="col-sm-3 control-label">Request For Vendor</label>
										<div class="col-sm-6">
											<select class="form-control" name="request" id="request">     
                                                                                    ...
                                                                                    <input type="hidden" class="form-control"  placeholder="" name="vendor_id" id="vendor_id" readonly>
										</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Meeting Reason</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" id="meeting_reason" name="meeting_reason" placeholder="Enter Meeting Reason...">
									</div>
								</div>   
                                                                <div class="form-group">
                                                                 ...
                                                                 <div class="form-group">
									<label class="col-sm-3 control-label">Meeting Status</label>
										<div class="col-sm-6">
                        ...
                        if(reason == "" || date == "")
                           {
                               alert("Please insert required fields");
                                   ...
                                   $.ajax({
                                        url: "<?php echo base_url(); ?>"+"Create_Meeting_Request/meeting_data",
                                       type: "POST",
                                       data: formData,
                                       async: false,
                                       dataType:'JSON',
 ...
 function display_meeting_request()
        {
            $.ajax
                  ({
                      type: "POST",
                      url: "<?php echo base_url(); ?>"+"Create_Meeting_Request/get_meeting_data",
                      dataType: 'json',                
      ...
      function display_meeting_status()
            {
                    $.ajax
                        ({
                            type: "POST",
                            url: "<?php echo base_url(); ?>"+"Create_Meeting_Request/get_meeting_request",
                            dataType: 'json',                
