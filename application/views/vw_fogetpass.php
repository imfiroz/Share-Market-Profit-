								...
								<div class="vd_content-section clearfix">
									...
									<div class="vd_login-page">
										<div class="heading clearfix">
											<div class="logo">
												<h2 class="mgbt-xs-5">
													<a href="index.html"><img src="<?php echo base_url()?>img/stylevalley.png" alt="logo"></a>
												</h2>
											</div>
												...
												<?php
													...
													<div class="form-group mgbt-xs-20">
														<div class="col-md-12">
															...
															<form action="<?php echo base_url();?>welcome/reset_pass" method="post">
													...
													<div class="form-group" id="submit-password-wrapper">
														<div class="col-md-12 text-center mgbt-xs-5">
															<button class="btn vd_bg-green vd_white width-100"
																...
																name="submit_password">Send me my password</button>
														</div>
