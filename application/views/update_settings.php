				...
				<div class="panel">
					<div class="panel-body">
						...
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row" action="<?php echo base_url();?>System_Settings" id="button_submit" name="button_submit" method="post">
								<div class="form-group">
									...
									//echo"aaaaaaaaaaa";
									?>
										<input type="text" class="form-control" id="site_name" name="site_name" placeholder="Enter Site Name..." value="<?php  echo $row->site_name;?>">
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-6">
											<input type="text" class="form-control" id="default_email" name="default_email" placeholder="Enter Email..." value="<?php  echo $row->default_email;?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" name="date_format" id="date_format" placeholder="Enter IGST..." value="dd/mm/yyyy">
									</div>
								</div>
								<div class="form-group">
								...
								//	print_r($billers);
									foreach ($billers as $biller) {
										//echo $biller->Name;
										$bl[$biller->branch_id] = $biller->Name != '-' ? $biller->Name : $biller->Name;
									}
									echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $biller->Name), 'id="biller" data-placeholder="' . "select" . ' ' . "biller" . '" required="required" class="form-control input-tip select" style="width:100%;"');
									?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Barcode Renderer </label>
									<div class="col-sm-6">
										<!--<select id="barcode_renderer" class="form-control">
                    ...
                    'img' => 'Image',
						...
						echo form_dropdown('barcode_renderer', $options,$id_map, 'id="barcode_renderer" data-placeholder="' . "select" . ' ' . "barcode_renderer" . '" required="required" class="form-control input-tip select" style="width:100%;"');
								
                   // echo form_dropdown('barcode_renderer', $options,$id_map, ' id="barcode_renderer"','class="form-control"');
                    ?>
									</div>
								</div>	
								<div class="form-group">
									<label class="col-sm-3 control-label">Print Style </label>
									<div class="col-sm-6">
										<?php $options = array(
                    'bill' => 'Bill',
                    'invoice' => 'Invoice',
                    );
					echo form_dropdown('print_style', $options,$id_map, 'id="print_style" data-placeholder="' . "select" . ' ' . "print_style" . '" required="required" class="form-control input-tip select" style="width:100%;"');
						
                 //   echo form_dropdown('print_style', $options,$id_map, ' id="print_style"',' class="form-control input-tip select" style="width:100%;"');
                    ?>
									</div>
								</div>		
									<div class="form-group">
									<label class="col-sm-3 control-label">Business State </label>
									<div class="col-sm-6">
												 <?php
									$bl[""] = "";
									//print_r($billers);
									foreach ($states as $state) {
										//echo $biller->Name;
										$bl[$state->id] = $state->name != '-' ? $state->name : $state->name;
									}
									echo form_dropdown('state', $bl, (isset($_POST['sate']) ? $_POST['state'] : $state->name), 'id="state" data-placeholder="' . "selected" . ' ' . "state" . '" required="required" class="form-control input-tip select" style="width:100%;"');
									?>
									</div>
								</div>								
								<div>
                                  <button class="btn btn-alt btn-hover btn-black" name="update" id="update" href="#" style="margin-left:450px" type="submit" value="Update">
										<span>Update</span>
