...
//   echo $this->session->userdata('print_style');
   if($this->session->userdata('print_style')){
    ...
    $aadhar= $this->session->userdata('biller');
...
<!--                            <input type="text"  value="0" onkeyup="common_function()"name="txt_cgst_cal" id="txt_cgst_cal"> -->
    ...
    margin: auto;" >
			...
			<div id="xx_qrcode">
			 ...
			 <div id="demo" style="max-width: 480px;
    margin: auto;"  >
			<?php  //$biller= $this->session->userdata('biller');
			// print_r($biller);
...
<script>
 var selling_cost;var cal;var txt_cgst;var amount_display =0;
                         var s;      var cal_sg;
          var calculated_total;      var finnal_ig;      var tot;     var cal_cg;                     var txt_igst; 
        var txt_sgst; var Cost_1 ;	var qty ; var c ;var seal_cost; var type; var discount;var Discount_Rate;var cost_after_tax;var discounted_amount;var tax_to_be_calculated;var	total_tax;var state_name1;var state_name12;var gstin_number;var HSN_code;var qty_available;
function resetForm()
{//alert("aa");
    // alert(str);
                                    $.ajax
...
//		   for(var i=0; i<len; i++){
        ...
        var FV = 0;
          var amt = 0;
         var total_tax_amt = 0;
          var content1 = "<table size='40%' name='example'class='display1' id='example1' border='0'>";
                                 ...
                                 content1 += tr_str7;
                                  var tr_str1 = "<tr>" +
                                        "<td class='left'colspan='7' >"+barcode+$("#xx").html()+"</td>" +
										  //"<td class='left'colspan='6' >"+$("#xx_qrcode").html()+"</td>" +
//                                         "<td class='left'colspan='4' ></td>" +
											"<td class='left'colspan='6' >"+content1+"</td>" +
