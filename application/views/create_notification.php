						...
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row"  id="button_submit" name="button_submit" method="post">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="txt_branch_name" name="txt_branch_name" placeholder="Enter Notification..." >
                                                                                  <div id="121"></div>
									</div>
								</div>
...
/*$.each(this.elements, function () {
        ...
        $.ajax({
             url: "<?php echo base_url(); ?>"+"Create_Notification/level_save_data",
            type: "POST",
            data: formData,
            async: false,
           // dataType:'JSON',
            success: function (msg) {
				alert(msg);
              //alert(JSON.stringify(msg.redirect_path));
		  if(msg){
				  alert("Information Loaded Successfully");
				//url=msg.redirect_path;
				   window.location ="<?php echo base_url();?>"+"View_Notification";
