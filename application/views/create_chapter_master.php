						...
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row"  id="button_submit" name="button_submit" method="post">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="Code" name="Code" placeholder="Enter Name..." onblur="validate_chpter_code()">
    ...
    function validate_chpter_code()
	{
			...
			if(code!="" && code.match(codeformat))
                                         {   
                                            $.ajax
                                            ({	
                                              url: "<?php echo base_url(); ?>"+"Create_Chapter_Master/check_chapter",    
         ...
         $("form[name='button_submit']").submit(function(e)
            {
                        ...
                        e.preventDefault();
                        var name=$("#Code").val();
                        var chapter_dscrp=$("#code_decription").val();                      	 
                        if(name == "" || chapter_dscrp == "")
                           {
                               alert("Please insert required fields");
                                   ...
                                   $.ajax({
                                        url: "<?php echo base_url(); ?>"+"Create_Chapter_Master/chapter_data",
                                       type: "POST",
                                       data: formData,
                                       async: false,
                                       dataType:'JSON',
                                       success: function (msg)
                                                     {	
                                                        ...
                                                        {	
                                                           ...
                                                           window.location ="<?php echo base_url();?>"+"View_Chapter_Master";				
                                                         }				
                                                      },
                                       cache: false,
                                       contentType: false,
