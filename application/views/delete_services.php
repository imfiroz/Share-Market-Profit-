						...
						<div class="example-box-wrapper">
							...
							<!--	<div class="form-group">
								...
								<div class="form-group1">
									...
									<div class="col-sm-4">
									<table cellpadding="0" cellspacing="0" border="0" class="table table-responsive " name="MyTable" id="MyTable">
									...
									/*foreach($data as $dt){
										...
										?>
										<tr  class="color_change"  id="tr_<?php echo $dt['id'];?>"><td onclick="change_color(<?php echo $dt['id'];?>)" style="align" id="td_<?php echo $dt['id'];?>"><?php echo $dt['text'];?></td></tr>
									<?php }*/
									...
									<div class="col-sm-4">
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-responsive" name="MyTable" id="MyTable">
									<tr><th colspan="">Services Name</th><th colspan="">Level Name</th><th>Delete</th></tr>
									<tbody>
									<?php //print_r($data);
									$a=array();
									...
									foreach($data1 as $dt){
										array_push($a,$dt['id']);
										 ...
										 $dt['id'];//
										?><tr  class="color" id="tr_<?php echo $dt['id'];?>"><td><?php echo $dt['s_name'];?></td><td style="align" id="<?php echo $dt['id'];?>"><?php echo $dt['l_name'];?></td><td><a href=""></td></tr>
									<?php }//print_r($a);
	    ...
	    $(document).on('change', '.itemName', function () {
			...
			// alert(cn);
			 ...
			 {cn = $(this).val() ? $(this).val() : '';
				 ...
				 //alert(cn);
				  x[cn-1].style.backgroundColor = "white"; 
				  cn = $(this).val() ? $(this).val() : '';
				   x[cn-1].style.backgroundColor = "#93487f";
				   change_color(cn);
