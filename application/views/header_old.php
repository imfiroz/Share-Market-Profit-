...
<link rel="shortcut icon" href="<?php echo base_url() ?>Main-Web/assets/images/owo-icon.png">
...
<div id="sidebar-toggle-4" class="collapse in">
    ...
    <ul id="sidebar-menu">
    <li class="header"><span style="color:red">Overview</span></li>
    <li>
        <a href="<?php echo base_url(); ?>Dashboard" title=" Create Customer"><span style="color:red">Admin Dashboard</span></a>
    </li>
    <li class="divider"></li>
   
    <li class="header"><span style="color:red">Components</span></li>
	<li>
        <a href="#" title="Customer">
           <img src="<?php echo base_url(); ?>icons/customer.png"  height="20" width="20">
            <span style="color:red">CUSTOMER</span>
        </a>
        <div class="sidebar-submenu">

            <ul> 
                <li><a href="<?php echo base_url(); ?>Create_Customer" title=" Create Customer"><span>Create Customer</span></a></li>               
                <li><a href="<?php echo base_url(); ?>View_Customer" title="View Customer"><span>View Customer</span></a></li>
                <li><a href="<?php echo base_url(); ?>Upload_Customer?type=customer" title="Upload customer"><span>Upload Customer</span></a></li> 
	<li><a href="<?php echo base_url(); ?>Upload_Customer?type=vendor" title="Upload customer"><span>Upload Vendor</span></a></li> 				             
            </ul>
	...
	<li>
        <a href="#" title="Product">
          <img src="<?php echo base_url(); ?>icons/product.png"  height="20" width="20">
    ...
    <li>
        <a href="#" title="Product Category">
           <img src="<?php echo base_url(); ?>icons/productcategory.png"  height="20" width="20">
            <span style="color:red">PRODUCT CATEGORY</span>
        </a>
        <div class="sidebar-submenu">

            <ul>
                <li><a href="<?php echo base_url(); ?>Create_Product_Category" title=" Create Product Category"><span>Create Product Category</span></a></li>               
              <!--  <li><a href="<?php echo base_url(); ?>Create_Hsn" title="View Product"><span>View Product</span></a></li>
                <li><a href="<?php echo base_url(); ?>upload_Product" title="Upload Product"><span>Upload Product</span></a></li>     -->         
            </ul>
	...
	<li>
        <a href="#" title="HSN">
           <img src="<?php echo base_url(); ?>icons/hsn.png"  height="20" width="20">
            <span style="color:red">HSN</span>
        </a>
        <div class="sidebar-submenu">

            <ul>
              <li><a href="<?php echo base_url(); ?>Create_Hsn" title="Create HSN"><span>Create HSN</span></a></li>  
                <li><a href="<?php echo base_url();?>View_Hsn" title="View HSN"><span>View HSN</span></a></li>
                <li><a href="<?php echo base_url(); ?>Upload_Hsn" title="Upload HSN"><span>Upload HSN</span></a></li>         
            </ul>

        </div><!-- .sidebar-submenu -->
    </li>
	 <li>
        <a href="#" title="BUSINESS CATEGORY">
          <img src="<?php echo base_url(); ?>icons/businesscategory.png"  height="20" width="20">
            <span style="color:red">BUSINESS CATEGORY</span>
        </a>
        <div class="sidebar-submenu">
            <ul>
                <li><a href="<?php echo base_url(); ?>Create_Business_Category" title=" Create BUSINESS CATEGORY"><span>Create BUSINESS CATEGORY</span></a></li>               
                <li><a href="<?php echo base_url(); ?>View_Business_Category" title="View BUSINESS CATEGORY"><span>View BUSINESS CATEGORY</span></a></li>
                <li><a href="<?php echo base_url(); ?>Upload_Business_Category" title="Upload BUSINESS CATEGORY"><span>Upload BUSINESS CATEGORY</span></a></li>              
            </ul>

        </div><!-- .sidebar-submenu -->
    </li>
	 <li>
        <a href="#" title="CHAPTER MASTER">
           <img src="<?php echo base_url(); ?>icons/chaptermaster.png"  height="20" width="20">
            <span style="color:red">CHAPTER MASTER</span>
        </a>
        <div class="sidebar-submenu">
            <ul>
                <li><a href="<?php echo base_url(); ?>Create_Chapter_Master" title=" Create CHAPTER MASTER"><span>Create CHAPTER MASTER</span></a></li>               
                <li><a href="<?php echo base_url(); ?>View_Chapter_Master" title="View CHAPTER MASTER"><span>View CHAPTER MASTER</span></a></li>
                <li><a href="<?php echo base_url(); ?>Upload_Chapter_Master" title="Upload CHAPTER MASTER"><span>Upload CHAPTER MASTER</span></a></li>              
            </ul>

        </div><!-- .sidebar-submenu -->
    </li>
	 <li>
        <a href="#" title="STATE MASTER">
          <img src="<?php echo base_url(); ?>icons/statemaster.png"  height="20" width="20">
            <span style="color:red">STATE MASTER</span>
        </a>
        <div class="sidebar-submenu">
            <ul>
                <li><a href="<?php echo base_url(); ?>Create_State_Master" title=" Create CHAPTER MASTER"><span>Create STATE MASTER</span></a></li>               
                <li><a href="<?php echo base_url(); ?>View_State_Master" title="View CHAPTER MASTER"><span>View STATE MASTER</span></a></li>
                <li><a href="<?php echo base_url(); ?>Upload_State_Master" title="Upload CHAPTER MASTER"><span>Upload STATE MASTER</span></a></li>              
            </ul>
	 ...
	 <li>
        <a href="#" title="Vendor">
          <img src="<?php echo base_url(); ?>icons/vendor.png"  height="20" width="20">
            <span style="color:red">VENDOR</span>
        </a>
        <div class="sidebar-submenu">
            <ul>                            
                <li><a href="<?php echo base_url(); ?>View_Vendor" title="View Vendor"><span>View Vendor</span></a></li>                              
            </ul>
        </div><!-- .sidebar-submenu -->
    </li>
     <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                <li><a href="<?php echo base_url(); ?>Generate_Invoice" title=" Generate Invoice"><span>Generate Invoice</span></a></li>               
                <li><a href="<?php echo base_url(); ?>Pending_Invoice" title="Pending Invoice"><span>Pending Invoice</span></a></li> 
                <ul>               
                <li><a href="<?php echo base_url(); ?>Pending_Invoice" title="Pending Invoice1"><span>Pending Invoice11</span></a></li> 
                  </ul>           
            </ul>
	...
	<li>
        <a href="#" title="MEETING STATUS">
          <img src="<?php echo base_url(); ?>icons/meetingstatus.png"  height="20" width="20">
            <span style="color:red">MEETING STATUS</span>
        </a>
        <div class="sidebar-submenu">
            <ul>
                <li><a href="<?php echo base_url(); ?>Create_meeting_status" title=" Create MEETING STATUS"><span>Create MEETING STATUS</span></a></li>               
                <li><a href="<?php echo base_url(); ?>View_meeting_status" title="View MEETING STATUS"><span>View MEETING STATUS</span></a></li>                         
            </ul>
        </div>
    </li>
   
	<li>
        <a href="#" title="MEETING REQUEST">
            <img src="<?php echo base_url(); ?>icons/meetingrequest.png"  height="20" width="20">
            <span style="color:red">MEETING REQUEST</span>
        </a>
        <div class="sidebar-submenu">
            <ul>
                <li><a href="<?php echo base_url(); ?>Create_Meeting_Request" title=" Create MEETING REQUEST"><span>Create MEETING REQUEST</span></a></li>                                                 
            </ul>
        </div>
    </ul>
</li>
