						...
						<div class="example-box-wrapper">
							<form class="form-horizontal bordered-row"  id="button_submit" name="button_submit" method="post">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="txt_branch_name" name="txt_branch_name" placeholder="Enter Domain Name..." >
                                                                                  <div id="121"></div>
									</div>
								</div>
...
/*$.each(this.elements, function () {
        ...
        $.ajax({
             url: "<?php echo base_url(); ?>"+"Create_Level/level_save_data",
            type: "POST",
            data: formData,
            async: false,
           // dataType:'JSON',
		  ...
		  if(msg){
				...
				//url=msg.redirect_path;
				   window.location ="<?php echo base_url();?>"+"View_Level";
