						...
						<div class="example-box-wrapper" >
							<form class="form-horizontal bordered-row"  id="btnCustLogin_form" name="btnCustLogin_form" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" name="txt_discount_amount" id="txt_discount_amount" placeholder="Enter Discount Amount...">
									</div>
								</div>								
								<div class="form-group">
                                      ...
                                      <form method="POST" action="" name="btnCustLogin_modal" id="btnCustLogin_modal"> 
                                         ...
                                         <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" placeholder="" onkeyup="common_function()"
                                                 ...
                                                 <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="file" class="upload" name="image_version[]" id="image_version"> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" placeholder="" onkeyup="common_function1()"
                                                               name="txt_product_price_modal1" id="txt_product_price_modal1">
...
<script>
    ...
    { // alert("aaaa");
        ...
        var txt_product_main_category = $("#txt_product_category").val();
        var txt_product_category = $("#txt_product_name").val();
   ...
   $('#myModal').modal('hide');
  // document.getElementById("btnCustLogin").reset();
   $("#product_data").hide();
   // $("#step").hide();
 //  $("#txt_chapter_div").html("");
   ...
   get_version_details1(product_id);
   }
    });
 ...
 // alert(id);
    ...
    function get_version_details1(product_id)
    {
       // var table = $('#example').DataTable();
           // table.clear().draw();
       $.ajax({
